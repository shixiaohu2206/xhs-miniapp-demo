...
export default defineConfig(async (merge, { command, mode }) => {
  const baseConfig: UserConfigExport = {
    ...
    compiler: {
      ...
      // prebundle: {
      //   exclude: [
      //     "@lucky-canvas/taro/react",
      //     // path.resolve(__dirname, "/src/aaa-bbb-xhs/index.xhsml"),
      //     (modulePath) => modulePath.indexOf(".xhsml") >= 0,
      //   ],
      // },
    ...
    mini: {
      ...
      webpackChain(chain) {
        ...
        //           const nodeModulesRegx = new RegExp(/node_modules/, 'gi')
